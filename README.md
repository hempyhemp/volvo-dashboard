# ESP32-2432S028 — базовый тестовый проект

Минимальный проект PlatformIO для платы **TENSTAR ROBOT ESP32-2432S028**
(жёлтая плата с встроенным TFT-дисплеем 2.8", 320x240, ILI9341).

Текущий этап: экран на плате рисует LVGL (через мост в `src/main.cpp`
на базе `TFT_eSPI`), сам интерфейс — в `lib/ui_demo/`. K-Line и ЭБУ
Январь 5.1 пока не подключены — см. [`PROJECT_CONTEXT.md`](./PROJECT_CONTEXT.md)
и [`docs/HARDWARE.md`](./docs/HARDWARE.md).
