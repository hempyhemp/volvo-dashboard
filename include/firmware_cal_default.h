...
// РАБОЧИЙ состав смеси для расчёта расхода (НЕ химическая стехиометрия!).
// 12.5 — по карте состава смеси из прошивки: в рабочей части она почти
// сплошь 12.52. Настоящие 14.7 живут в kline_test.cpp как KLINE_AFR_CHEM и
// используются только в расчёте мощности. Подробности в firmware_cal.ini.
#ifndef FWCAL_AFR_STOICH_X100
#define FWCAL_AFR_STOICH_X100 1250
#endif
